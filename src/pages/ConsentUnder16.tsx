  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <header className="space-y-3">
        ...
        <div className="mt-2">
          <ReadAloud text="Even though you're under 16, your voice matters! Here's how decisions about your healthcare work, when you might be able to decide things yourself, and how your family stays involved." />
        </div>
      </header>
      ...
      <section className="grid gap-6 md:grid-cols-[minmax(0,2fr)_minmax(0,1.1fr)]">
        <div className="space-y-6">
          <Card title="The basics 📌">
            ...
            <div className="mt-2"><ReadAloud text="Usually your parents or carers make healthcare decisions with you. But your opinion really matters - staff should always ask what YOU think. Sometimes you can make decisions yourself if you understand enough, this is called being Gillick competent. As you get older and more mature, you'll have more say in your care." /></div>
          </Card>
          ...
          <Card title="What is Gillick Competence?" emoji="🌟">
            ...
            <div className="mt-2"><ReadAloud text="Gillick competent is a way of saying you understand enough to make your own decisions about treatment, even without your parents agreeing. It's named after a court case from the 1980s. Staff will think about how well you understand the treatment, whether you understand what could happen without treatment, your maturity and ability to think things through, and whether you can explain your decision. Being Gillick competent isn't about your age - it's about your understanding. A mature 13-year-old might be competent for some decisions, while a 15-year-old might need more support for others." /></div>
          </Card>
          ...
          <Card title="Fraser Guidelines" emoji="📋">
            ...
            <div className="mt-2"><ReadAloud text="Fraser guidelines are similar to Gillick competence but specifically about contraception and sexual health advice. They help staff decide if they can give you this advice without telling your parents. Staff will check that you understand the advice being given, they can't persuade you to tell your parents, you're likely to have sex with or without contraception, your health would suffer without the advice or treatment, and it's in your best interests to give advice without parental consent." /></div>
          </Card>
          ...
          <Card title="How decisions work day-to-day" emoji="🔄">
            ...
            <div className="mt-2"><ReadAloud text="Most of the time, decisions happen together with you, your family, and your healthcare team. For routine appointments, staff will ask YOU how you're feeling and what's happening. Your parents might add details, but your experience matters most. For starting new treatments, staff will explain what the treatment does and ask if you have questions. Your parent usually signs consent, but you should understand and agree too. For tests and procedures, before any test, staff should explain what will happen. You can ask questions and say if you're worried or uncomfortable." /></div>
          </Card>
          ...
          <Card title="Your right to be heard" emoji="🗣️">
            ...
            <div className="mt-2"><ReadAloud text="Even if you can't make the final decision, you have the right to have things explained in a way you understand, ask questions about your care, say what you prefer and why, have your views taken seriously, and know why a decision was made." /></div>
          </Card>
          ...
          <Card title="What if I disagree with my parents?" emoji="😕">
            ...
            <div className="mt-2"><ReadAloud text="Sometimes you might want something different from what your parents want. This can be tricky, but here's what can help: Talk to your healthcare team - they can help explain your point of view to your parents. Ask if you can have some time alone with the doctor or nurse. If it's about something you feel strongly about, staff will consider if you're Gillick competent for that decision. You can ask for an advocate - someone independent who can help you express your views. Remember: Your parents usually want what's best for you, even when it doesn't feel like it. Healthcare staff will try to help everyone work together." /></div>
          </Card>
        </div>
        ...
        <aside className="space-y-4">
          ...
          <Card title="Privacy under 16 🔒">
            ...
            <div className="mt-2"><ReadAloud text="You have some privacy rights even under 16. You can ask to speak to staff privately. Some things can stay between you and your doctor. Staff must share if they're worried about your safety." /></div>
          </Card>
          ...
          <Card title="Questions to ask 📝">
            ...
            <div className="mt-2"><ReadAloud text="Questions to ask: Can you explain what this treatment does? What are my choices? Can I have some time to think about it? Can I talk to you without my parents for a bit?" /></div>
          </Card>
        </aside>
      </section>
    </div>
